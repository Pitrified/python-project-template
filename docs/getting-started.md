...
The project expects environment variables to be stored in `~/cred/project_name/.env`.
...
See the [meta README](https://github.com/YOUR_USERNAME/project-name/blob/main/meta/README.md) for detailed instructions.
